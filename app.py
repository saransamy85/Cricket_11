...
def result():
    ...
    if request.method=="POST":
        ...
        #======Bowler======#
        bowling=dl2.loc[(dl2["Wkts"]>3.0) & (dl2["Econ"]>4.0) & (dl2["Stadium"]==std)]
        ...
        bowX_train,bowX_test,bowy_train,bowy_test=train_test_split(bowx,bowy,test_size=0.2)
        from sklearn.neighbors import KNeighborsClassifier
        ...
        #+++++++++++++AllRounder++++++++++++#
        Allr=dl3.loc[(dl3["Runs"]>50) & (dl3["Wkts"]>2.0) & (dl3["Stadium"]==std)]
        ...
        allX_train,allX_test,ally_train,ally_test=train_test_split(allx,ally,test_size=0.2)
        from sklearn.neighbors import KNeighborsClassifier
        ...
        return render_template("result.html",batts=pred2[0:int(bat)],bowws=bowlerprediction[0:int(bow)],alls=allprediction[0:int(allrd)])
    else:
